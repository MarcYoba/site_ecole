 ...
 */
final class Version20250806141014 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE classe ADD CONSTRAINT FK_8F87BF963256915B FOREIGN KEY (relation_id) REFERENCES classe (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
