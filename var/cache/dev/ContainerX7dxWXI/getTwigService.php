...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'E:\\site_ecole');
        $a->addPath('E:\\site_ecole\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('E:\\site_ecole\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('E:\\site_ecole\\vendor\\doctrine\\doctrine-bundle/templates', 'Doctrine');
        $a->addPath('E:\\site_ecole\\vendor\\doctrine\\doctrine-bundle/templates', '!Doctrine');
        $a->addPath('E:\\site_ecole\\vendor\\doctrine\\doctrine-migrations-bundle/templates', 'DoctrineMigrations');
        $a->addPath('E:\\site_ecole\\vendor\\doctrine\\doctrine-migrations-bundle/templates', '!DoctrineMigrations');
        $a->addPath('E:\\site_ecole/templates');
        $a->addPath('E:\\site_ecole\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('E:\\site_ecole\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('E:\\site_ecole\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($container->privates['debug.file_link_formatter'] ?? ($container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))), 'E:\\site_ecole', 'UTF-8'));
